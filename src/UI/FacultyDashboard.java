...
public class FacultyDashboard extends JFrame {
    ...
    private void initializeUI() {
         ...
         * inputTextField.setPreferredSize(new Dimension(150,
         * inputTextField.getPreferredSize().height)); // Set preferred size
     ...
     * FileReader("FacultyUsers.csv"))) {
     * String line;
     * while ((line = reader.readLine()) != null) {
     * String[] parts = line.split(",");
     * String userId = parts[0].trim();
     * String courseCode = parts[1].trim();
     * String textbook = getTextbookForCourse(courseCode); // Get the textbook for
     * the course
     * 
     ...
     * for (User user : users) {
     * userListTextArea.append("User ID: " + user.getUserId() + " - Course Code: " +
     * user.getCourseCode() + " - Textbook: " + user.getTextbook() + "\n");
     * }
     * }
     */
